                ...
                <div class="bg-white rounded-xl shadow-sm border border-[color:var(--gray-200)] overflow-hidden mb-6">
                    <div class="px-4 md:px-6 py-4 border-b border-[color:var(--gray-200)] bg-[color:var(--gray-100)]">
                        <div class="flex items-center">
                            ...
                            <h3 class="text-base md:text-lg font-semibold text-[color:var(--ink)]">Acciones realizadas</h3>
                        </div>
                    ...
                    <div class="p-4 md:p-6 space-y-4 md:space-y-6">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--pri-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div
                                    class="bg-[color:var(--pri-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">
                                    1
                                </div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Congreso Nacional de Educación
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--sec-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div
                                    class="bg-[color:var(--sec-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">
                                    2
                                </div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Lanzamiento del Consejo
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--ter-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div
                                    class="bg-[color:var(--ter-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">
                                    3
                                </div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Capacitación y articulación
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--acc-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div
                                    class="bg-[color:var(--acc-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">
                                    4
                                </div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Acompañamiento territorial del
                        ...
                        <!-- 5 -->
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--pri-700)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div
                                    class="bg-[color:var(--pri-700)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">
                                    5
                                </div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Jornada en la Escuela
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--sec-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Acompañamiento en el
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--ter-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Intervenciones ante
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--acc-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Firma de convenios con
                                    empresas</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--pri-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Articulación interministerial</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--sec-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Asistencia a Mesas Federales
                                    INET</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--ter-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Reunión con centros de
                                    estudiantes</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--acc-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Inauguración del Centro
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--pri-700)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Acompañamiento en el Rally del
                                    Poncho 2025</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                        ...
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--sec-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                ...
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">Apoyo técnico a instituciones
                                    educativas</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
