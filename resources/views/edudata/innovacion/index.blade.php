...
@section('title', 'Innovación Educativa')
                        ...
                        <div class="bg-gradient-to-br from-[#f0f4ff] to-[#f8f7ff] rounded-xl p-4 md:p-5 my-4 border border-[color:var(--pri-500)]/20" style="--tw-gradient-from: #f0f4ff; --tw-gradient-to: #f8f7ff;">
                            ...
                            <div class="text-center mb-4 md:mb-5">
                                <p class="text-[color:var(--ink)] leading-relaxed text-base md:text-lg">
                                    La <span class="font-semibold text-[color:var(--pri-700)]">Secretaría de Innovación Educativa</span> 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                                ...
                                <div class="feature-card group p-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-semibold text-[color:var(--ink)]">Inteligencia Artificial</p>
                                ...
                                <div class="feature-card group p-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-semibold text-[color:var(--ink)]">Alfabetización Digital</p>
                                ...
                                <div class="feature-card group p-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-semibold text-[color:var(--ink)]">Innovación Sostenible</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-6">
                    <div class="bg-white rounded-xl shadow-sm border border-[color:var(--gray-200)] p-4 md:p-6 flex flex-col h-full">
                        <div class="flex items-center mb-4">
                            ...
                            <h2 class="text-lg md:text-xl font-semibold text-[color:var(--ink)]">Secretaría de Innovación Educativa</h2>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-[color:var(--gray-200)] p-4 md:p-6 flex flex-col h-full">
                        <div class="flex items-center mb-4">
                            ...
                            <h2 class="text-lg md:text-xl font-semibold text-[color:var(--ink)]">Nuestra visión</h2>
                        </div>
                        <p class="text-[color:var(--ink)] leading-relaxed flex-grow text-sm md:text-base">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-[color:var(--gray-200)] overflow-hidden mb-6">
                    <div class="px-4 md:px-6 py-4 border-b border-[color:var(--gray-200)] bg-[color:var(--gray-100)]">
                        <div class="flex items-center">
                            ...
                            <h3 class="text-base md:text-lg font-semibold text-[color:var(--ink)]">Programas y acciones</h3>
                        </div>
                    ...
                    <div class="p-4 md:p-6 space-y-4 md:space-y-6">
                        <!-- 1 -->
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--pri-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div class="bg-[color:var(--pri-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">1</div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">"Educar en la era de la IA: oportunidades y desafíos para el sistema educativo provincial"</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                                <p class="mb-2">
                                ...
                                <div class="bg-[color:var(--pri-500)]/10 p-3 rounded-lg mt-3">
                                    <p class="text-[color:var(--pri-700)] font-semibold text-sm md:text-base"><strong>716</strong> docentes, directivos y referentes educativos capacitados en capital y en el departamento Belén.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- 2 -->
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--sec-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div class="bg-[color:var(--sec-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">2</div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">"La IA como aliada en la planificación áulica"</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                                <p class="mb-2">
                                ...
                                <div class="bg-[color:var(--sec-500)]/10 p-3 rounded-lg mt-3">
                                    <p class="text-[color:var(--sec-500)] font-semibold text-sm md:text-base"><strong>1.200</strong> docentes capacitados en modalidad presencial y virtual.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- 3 -->
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--acc-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div class="bg-[color:var(--acc-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">3</div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">"Familias Conectadas"</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                                <p class="mb-2">
                                ...
                                <div class="bg-[color:var(--acc-500)]/10 p-3 rounded-lg mt-3">
                                    <p class="text-[color:var(--acc-500)] font-semibold text-sm md:text-base"><strong>800</strong> familias participaron activamente en los encuentros.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- 4 -->
                        <div class="rounded-lg border border-[color:var(--gray-200)] overflow-hidden shadow-sm">
                            <div class="px-4 md:px-5 py-3 md:py-4 bg-[color:var(--ter-500)]/10 border-b border-[color:var(--gray-200)] flex items-center">
                                <div class="bg-[color:var(--ter-500)] text-white rounded-full h-7 w-7 md:h-8 md:w-8 flex items-center justify-center mr-3 text-sm md:text-base">4</div>
                                <h4 class="text-sm md:text-base font-semibold text-[color:var(--ink)]">"Innovación Sostenible"</h4>
                            </div>
                            <div class="px-4 md:px-5 py-3 md:py-4 text-[color:var(--ink)] leading-relaxed text-sm md:text-base">
                                <p class="mb-2">
                                ...
                                <div class="bg-[color:var(--ter-500)]/10 p-3 rounded-lg mt-3">
                                    <p class="text-[color:var(--ter-500)] font-semibold text-sm md:text-base"><strong>45</strong> proyectos escolares innovadores presentados por estudiantes de toda la provincia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-[color:var(--gray-200)] overflow-hidden mb-6">
                    <div class="px-4 md:px-6 py-4 border-b border-[color:var(--gray-200)] bg-[color:var(--gray-100)]">
                        <div class="flex items-center">
                            ...
                            <h3 class="text-base md:text-lg font-semibold text-[color:var(--ink)]">Impacto global en el período</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
                            <div class="bg-[color:var(--pri-500)]/5 p-4 md:p-5 rounded-lg border border-[color:var(--pri-500)]/20">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h4 class="text-base md:text-lg font-semibold text-[color:var(--pri-700)]">Alcance de capacitación</h4>
                                </div>
                                <p class="text-[color:var(--pri-700)] text-2xl md:text-3xl font-bold">+6.000</p>
                                <p class="text-[color:var(--pri-600)] text-sm md:text-base">personas capacitadas en toda la provincia</p>
                            </div>
                            ...
                            <div class="bg-[color:var(--acc-500)]/5 p-4 md:p-5 rounded-lg border border-[color:var(--acc-500)]/20">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h4 class="text-base md:text-lg font-semibold text-[color:var(--acc-500)]">Proyectos en marcha</h4>
                                </div>
                                <p class="text-[color:var(--acc-500)] text-2xl md:text-3xl font-bold">45</p>
                                <p class="text-[color:var(--acc-500)]/80 text-sm md:text-base">proyectos escolares innovadores</p>
                            </div>
                        </div>

                        <div class="bg-[color:var(--gray-100)] p-4 md:p-5 rounded-lg border border-[color:var(--gray-200)]">
                            <h4 class="text-base md:text-lg font-semibold text-[color:var(--ink)] mb-3">Logros destacados</h4>
                            <ul class="list-disc pl-5 md:pl-6 space-y-2 text-[color:var(--ink)] text-sm md:text-base">
