...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 rounded-xl overflow-hidden">
        <img src="{{ asset('images/bannertitulos-v2.png') }}" alt="Banner Títulos y Legalizaciones"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="inline-block bg-gray-100/80 px-6 py-3 rounded-lg mb-6 backdrop-blur-sm border border-gray-200">
                <p class="text-lg font-medium text-gray-700">
                    Información proporcionada por la <strong>Dirección de Legalización y Registro de Títulos</strong>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-full">
            ...
            <p class="text-gray-700 leading-relaxed flex-grow">
                ...
                avanzando en la despapelización de los procesos mediante la implementación del Sistema de Título Digital.
            </p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-purple-50 p-5 rounded-lg border border-purple-100">
                    ...
                    <ul class="list-disc pl-5 space-y-2 text-purple-700">
                        <li><strong>Res. Min. 201/24</strong> - Implementación del Sistema de Título Digital en la Provincia de Catamarca y Reglamentación Jurisdiccional</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="prose max-w-none text-gray-700 mb-6">
                ...
                <p>
                    ...
                    identificados como "Carga y Firma", culminando el proceso con Firma Digital y código QR para cada certificado.
                </p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-10">
        ...
        <div class="p-6">
            ...
            <!-- Estadísticas 2025 -->
            <div class="mb-8">
                <h4 class="text-lg font-semibold text-gray-800 mb-4">Implementación SISFET Web - Año 2025 (Parcial)</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
