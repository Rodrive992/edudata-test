...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 rounded-xl overflow-hidden">
        <img src="{{ asset('images/banner-residencia-v2.png') }}" alt="Banner Residencia Universitaria"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="inline-block bg-gray-100/80 px-6 py-3 rounded-lg mb-6 backdrop-blur-sm border border-gray-200">
                <p class="text-lg font-medium text-gray-700">
                    Información de la <strong>Dirección Provincial de la Residencia Universitaria</strong>, dependiente de la Secretaría de Innovación Educativa
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <img src="{{ asset('images/residencia.jpg') }}" alt="Residencia Universitaria Abuelas de Plaza de Mayo" class="w-full h-full object-cover">
        </div>
    </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-100 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-600 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-100 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-indigo-600 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                        ...
                        <p class="text-blue-600 text-center text-sm mt-2">De todos los departamentos de la provincia</p>
                    </div>
                </div>
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 text-sm">
                    <div class="bg-gray-50 p-3 rounded border border-gray-200">Tec. en Procesamiento de Salmuera y Litio</div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <p class="text-gray-700">Lic. Luz Pizarro (Lic. en Trabajo Social y Prof. en Cs. de la Educación)</p>
                </div>
            ...
            <div class="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                <p class="text-gray-700 text-sm italic">Además del personal mencionado, la residencia cuenta con personal administrativo, cocinero, personal de limpieza y becarios/as que contribuyen al funcionamiento integral del establecimiento.</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-10">
        ...
        <div class="pl-12">
            <ul class="list-disc space-y-2 text-gray-700">
                <li><strong>Decreto Acuerdo N.º 1068/15</strong>, publicado en el B.O. N.º 87/15: determina la creación, objetivos y fines del establecimiento.</li>
                <li><strong>Anexo II del Decreto Acuerdo N.º 1068/15</strong>: Reglamento General de Acceso, Permanencia y Egreso a la RUP.</li>
            </ul>
            
            <div class="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <p class="text-blue-800 font-semibold">Importante:</p>
                <p class="text-blue-700 mt-2">Todos los servicios y beneficios que brinda la Residencia Universitaria Provincial "Abuelas de Plaza de Mayo" son completamente gratuitos para los y las estudiantes residentes.</p>
                <p class="text-blue-700 mt-2">Este funcionamiento sin costo alguno representa un esfuerzo significativo y sostenido por parte del Gobierno de la Provincia de Catamarca, a través del Ministerio de Educación.</p>
            </div>
        </div>
    </div>
</div>
