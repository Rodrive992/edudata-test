...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 rounded-xl overflow-hidden">
        <img src="{{ asset('images/bannerprogramas-v2.png') }}" alt="Banner Programas y Proyectos"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="inline-block bg-gray-100/80 px-6 py-3 rounded-lg mb-6 backdrop-blur-sm border border-gray-200">
                <p class="text-lg font-medium text-gray-700">
                    Información de la <strong>Dirección Provincial Unidad Ejecutora de Programas y Proyectos</strong>, dependiente de la Secretaría de Articulación Institucional
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-full">
            ...
            <p class="text-gray-700 leading-relaxed flex-grow">
                ...
                realizando ejecuciones presupuestarias y rendiciones por Sistema Sitrared. El Plan Fines inició actividades 
        ...
        <div class="p-6">
            ...
            <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                ...
                <ul class="list-disc pl-5 space-y-2 text-gray-700">
                    <li><strong>Educación Solidaria:</strong> Proyecto "Cuentos que Abrazan" con inicio el 29 de septiembre</li>
                    <li><strong>Alfabetización:</strong> Encargado de la ejecución del nuevo "Programa 40" de las 100 escuelas Alfa de la Provincia</li>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-purple-50 p-5 rounded-lg border border-purple-100">
                    ...
                    <ul class="list-disc pl-5 space-y-2 text-purple-700">
                        ...
                        <li>Articulación con dirección de modalidades para titulación en escuelas de jóvenes y adultos</li>
                    </ul>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-10">
        ...
        <div class="p-6 overflow-x-auto">
            <table class="min-w-full text-sm border-collapse border border-gray-300">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Denominación de la Política</th>
                        <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Línea de acción</th>
                        ...
                        <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Honorarios</th>
                        <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Bienes y servicios</th>
                ...
                <tfoot class="bg-gray-800 text-white">
                    <tr>
                        <td colspan="5" class="border border-gray-300 px-3 py-2 text-right font-semibold">TOTAL GENERAL</td>
            ...
            <div class="mt-4 text-sm text-gray-600">
                <p class="text-center italic">Matriz Jurisdiccional PEA 2025 - Resumen ejecutivo de las principales líneas de acción</p>
            </div>
        </div>
    </div>
</div>
