                ...
                <div class="carousel-track flex transition-transform duration-500 ease-in-out gap-4 md:gap-4">
                        ...
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                ...
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                                    Acometida y pilar de luz (mono → trifásica), revisión de cableado y tablero,
                                    recambio de llaves y luminarias en aulas.
                                </p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                ...
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                                    Mantenimiento de griferías en sanitarios, cambio de presmatic y llaves de agua;
                                    recambio en bebederos.
                                </p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                <h3 class="text-gray-900 font-semibold leading-tight">Escuela Nº 277 “N. Avellaneda”
                                </h3>
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                ...
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                                    Regularización de pilar de luz, cambio de cableado, colocación de caja y llaves
                                    térmicas.
                                </p>
                            </div>
                        </div>
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                <h3 class="text-gray-900 font-semibold leading-tight">Escuela Secundaria Clara J.
                                    Armstrong Nº 2l</h3>
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            class="group bg-white border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div class="h-48 md:h-56 overflow-hidden">
                                <img src="{{ asset('images/mantenimiento/mantenimiento14.jpg') }}"
                                    alt="Escuela Nº 45 Presidente Sarmiento"
                                    class="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-300">
                            </div>
                            <div class="p-3 md:p-4">
                                <h3 class="text-gray-900 font-semibold leading-tight">Reparación de instalaciones
                                    eléctricas, bombas de agua, recambio de luminarias y colocación</h3>
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            ...
                            <div class="p-3 md:p-4">
                                <h3 class="text-gray-900 font-semibold leading-tight">Escuela Nº 45 “Pte. Sarmiento”
                                </h3>
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            class="group bg-white border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div class="h-48 md:h-56 overflow-hidden">
                                <img src="{{ asset('images/mantenimiento/mantenimiento13.jpg') }}"
                                    alt="Escuela Nº 45 Presidente Sarmiento"
                                    class="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-300">
                            </div>
                            <div class="p-3 md:p-4">
                                <h3 class="text-gray-900 font-semibold leading-tight">Reparaciones y desobstrucción de
                                    cañerías</h3>
                                <p class="text-gray-700 text-sm mt-1 leading-relaxed">
                                    Tareas de plomeria.
                                </p>
                    ...
                    <article class="carousel-slide w-[280px] md:w-[320px] shrink-0">
                        <div
                            class="group bg-white border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div class="h-48 md:h-56 overflow-hidden">
                                <img src="{{ asset('images/mantenimiento/mantenimiento12.jpg') }}"
                                    alt="Escuela Nº 45 Presidente Sarmiento"
                                    class="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-300">
                            </div>
                            <div class="p-3 md:p-4">
