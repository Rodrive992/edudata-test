...
@section('content')
    <style>
        ...
        /* Tarjetas de contenido - MEJORADO CON BORDES REDONDEADOS */
        .file-card {
            background: #fff;
        ...
        /* Cabeceras sección - MEJORADO CON BORDES REDONDEADOS */
        .section-header {
        ...
        /* Estilos para las tarjetas de enlaces - MANTENIENDO INTERACTIVIDAD */
        .feature-card {
            background: white;
            border-radius: 12px;
            padding: 1.5rem;
                                ...
                                <div class="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-base md:text-lg font-bold text-gray-800 mb-1">Ubicación de
                                            Establecimientos</h4>
                                        <p class="text-xs text-gray-600 leading-relaxed">Mapa completo con la localización
                                ...
                                <div class="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-base md:text-lg font-bold text-gray-800 mb-1">Solicitudes de
                                            Mantenimiento</h4>
                                        <p class="text-xs text-gray-600 leading-relaxed">Generá solicitudes si pertenecés a
                    ...
                    <div class="folder-container mb-4 md:mb-6">
                        <div class="folder-stack px-4 md:px-6 pt-4 md:pt-6">
                            <template x-for="(tab,i) in tabs" :key="tab.key">
                                <button type="button"
                                    class="folder-tab px-3 md:px-6 py-2 md:py-4 mr-[-8px] md:mr-[-12px] border-2 border-b-0"
                                    :class="[
                        ...
                        <div class="border-t-0">
                            ...
                            <section x-show="active==='realizadas'" x-cloak
                                class="section-padding space-y-4 md:space-y-8">
                                <div class="search-form">
                                    <form method="GET" :action="currentUrlWithHash('#resultados')"
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2 md:mb-3">Buscar
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="absolute right-3 top-1/2 -translate-y-1/2">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-4 w-4 md:h-5 md:w-5 text-gray-400" fill="none"
                                                        viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div>
                                            <button type="submit"
                                                class="btn-responsive bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-lg shadow-lg transition-all duration-200 md:hover:shadow-xl md:transform md:hover:-translate-y-0.5">
                                ...
                                <div id="resultados" class="results-grid mobile-card-container">
                                    ...
                                    <div class="file-card" style="border-left-color:#8b5cf6;">
                                        <div class="section-header"
                                            ...
                                            <h3 class="text-base md:text-lg font-bold text-white">Albañilería - Plomería -
                                                Herrería</h3>
                                            <p class="text-xs md:text-sm text-white/90 mt-1">Registros:
                                                <strong>{{ $cntAPH }}</strong>
                                            </p>
                                        </div>
                                        <div
                                            class="p-3 md:p-6 {{ $scrollAPH ? 'max-h-48 md:max-h-96 overflow-y-auto pr-1 md:pr-2' : '' }} mobile-optimized">
                                            @forelse($regAPH as $r)
                                                <div
                                                    class="border-l-4 border-purple-400 bg-purple-50/50 rounded-r-lg p-2 md:p-4 mb-2 last:mb-0 hover:bg-purple-100/50 transition-colors">
                                                    <p class="font-semibold text-gray-800 text-xs md:text-sm">
                                                        <span
                                                            class="text-purple-600 font-bold">{{ \Carbon\Carbon::parse($r->fecha)->format('d/m') }}</span>
                                                        - {{ $r->establecimiento }}
                                                    </p>
                                            ...
                                            @empty
                                                <div class="text-center py-4 md:py-8">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-6 w-6 md:h-12 md:w-12 text-gray-400 mx-auto mb-2 md:mb-3"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                    </svg>
                                                    <p class="text-gray-500 italic text-xs md:text-sm">Sin tareas
                                                        registradas</p>
                                                </div>
                                            @endforelse
                                        </div>
                                    ...
                                    <div class="file-card" style="border-left-color:#3b82f6;">
                                        <div class="section-header"
                                            ...
                                            <p class="text-xs md:text-sm text-white/90 mt-1">Registros:
                                                <strong>{{ $cntELEC }}</strong>
                                            </p>
                                        </div>
                                        <div
                                            class="p-3 md:p-6 {{ $scrollELEC ? 'max-h-48 md:max-h-96 overflow-y-auto pr-1 md:pr-2' : '' }} mobile-optimized">
                                            @forelse($regELEC as $r)
                                                <div
                                                    class="border-l-4 border-blue-400 bg-blue-50/50 rounded-r-lg p-2 md:p-4 mb-2 last:mb-0 hover:bg-blue-100/50 transition-colors">
                                                    <p class="font-semibold text-gray-800 text-xs md:text-sm">
                                                        <span
                                                            class="text-blue-600 font-bold">{{ \Carbon\Carbon::parse($r->fecha)->format('d/m') }}</span>
                                                        - {{ $r->establecimiento }}
                                                    </p>
                                                    <p class="text-gray-600 text-xs md:text-sm mt-1 leading-relaxed">
                                                        {{ $r->tarea }}</p>
                                    ...
                                    <div class="file-card" style="border-left-color:#10b981;">
                                        <div class="section-header"
                                            ...
                                            <p class="text-xs md:text-sm text-white/90 mt-1">Registros:
                                                <strong>{{ $cntDEZM }}</strong>
                                            </p>
                                        </div>
                                        <div
                                            class="p-3 md:p-6 {{ $scrollDEZM ? 'max-h-48 md:max-h-96 overflow-y-auto pr-1 md:pr-2' : '' }} mobile-optimized">
                                            @forelse($regDEZM as $r)
                                                <div
                                                    class="border-l-4 border-green-400 bg-green-50/50 rounded-r-lg p-2 md:p-4 mb-2 last:mb-0 hover:bg-green-100/50 transition-colors">
                                                    <p class="font-semibold text-gray-800 text-xs md:text-sm">
                                                        <span
                                                            class="text-green-600 font-bold">{{ \Carbon\Carbon::parse($r->fecha)->format('d/m') }}</span>
                                                        - {{ $r->establecimiento }}
                                                    </p>
                                                    <p class="text-gray-600 text-xs md:text-sm mt-1 leading-relaxed">
                                                        {{ $r->tarea }}</p>
                            ...
                            <section x-show="active==='pendientes'" x-cloak
                                ...
                                <div class="search-form">
                                    <form method="GET" :action="currentUrlWithHash('#resultados-pend')"
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-2 md:mb-3">Filtrar
                                                por Localidad</label>
                                            <div class="relative">
                                        ...
                                        <div>
                                            <button type="submit"
                                                class="btn-responsive bg-gradient-to-r from-sky-600 to-sky-700 hover:from-sky-700 hover:to-sky-800 text-white font-bold rounded-lg shadow-lg transition-all duration-200 md:hover:shadow-xl md:transform md:hover:-translate-y-0.5">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-5 md:w-5"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                                    ...
                                                    <tr>
                                                        <td colspan="3" class="px-3 md:px-6 py-8 md:py-12 text-center">
                                                            <div class="flex flex-col items-center">
                                                                ...
                                                                <p class="text-gray-500 text-sm md:text-lg font-medium">No
                                                                    hay tareas pendientes</p>
                                                                <p class="text-gray-400 text-xs md:text-sm mt-1">Todos los
                            ...
                            <section x-show="active==='comisiones'" x-cloak
                                ...
                                <div class="search-form">
                                    <form method="GET" :action="currentUrlWithHash('#resultados-com')"
                                        ...
                                        <div>
                                            <button type="submit"
                                                class="btn-responsive bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white font-bold rounded-lg shadow-lg transition-all duration-200 md:hover:shadow-xl md:transform md:hover:-translate-y-0.5">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-5 md:w-5"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
