    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-2">
                <div class="inline-block bg-gray-100/80 px-6 py-2 rounded-full mb-4 backdrop-blur-sm">
                    <span class="text-ls font-semibold text-gray-700 uppercase tracking-wider">Acceso público a la
                        información
                        institucional del <span class="bg-gray-800 text-white px-3 py-1 rounded-md ml-1">Ministerio de Educación, Ciencia y Tecnología</span></span>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="https://web.catamarca.edu.ar/sitio/el-ministerio/estructura-organica.html"
                ...
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Organigrama</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Estructura organizativa del Ministerio de Educación y sus áreas dependientes.
                    </p>
                </div>
            </a>
            ...
            <a href="{{ route('edudata.mantenimiento') }}"
                ...
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Mantenimiento</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Información sobre tareas de programación, mantenimiento edilicio y servicios en establecimientos educativos.
                    </p>
                </div>
            </a>
            
            <!-- Administración y Ejecución -->
            <a href="{{ route('edudata.administracion') }}"
                class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 hover:border-blue-300 h-full flex flex-col">
                <div class="w-full h-48 flex items-center justify-center bg-gray-50 p-4">
                    <img src="{{ asset('images/logocapacitaciones.png') }}" alt="Administración"
                        class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                </div>
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Administración</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Gestión administrativa, presupuestaria y de recursos institucionales del Ministerio.
                    </p>
                </div>
            </a>
            ...
            <a href="{{ route('edudata.innovacion') }}"
                ...
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Innovación Educativa</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <a href="{{ route('edudata.formacion') }}"
                ...
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Formación y Programación</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Estrategias y planificación para el desarrollo y mejora continua del sistema educativo provincial.
                    </p>
                </div>
            </a>
            ...
            <a href="{{ route('edudata.asuntos') }}"
                ...
                <div class="p-5 flex-grow">
                    <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-gray-400 transition-colors">Asuntos Jurídicos</h3>
                    <p class="text-gray-600 text-sm leading-relaxed">
