...
<div class="container mx-auto px-4 py-8">
    ...
    @if(session('ok'))
        <div class="mb-6 rounded-xl bg-gray-100 border border-gray-300 text-gray-800 px-4 py-3 flex items-start">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-0.5 text-gray-600 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('edured.herramientas.digesto.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left font-semibold text-gray-700">Archivo</th>
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                @foreach($docs as $d)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-4 py-3">
                                            <form action="{{ route('edured.herramientas.digesto.destroy', $d) }}" method="POST"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                         fill="currentColor" class="w-4 h-4 group-hover:scale-110 transition-transform">
