                        ...
                        @forelse($solicitudes as $s)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-3 text-sm text-gray-700">
                                    {{ optional($s->created_at)->format('d/m/Y H:i') }}</td>
                                <td class="px-6 py-3 text-sm">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 border text-xs font-medium rounded-md {{ $badge }}">
                                        {{ ucfirst($estado) }}
                                    </span>
                                </td>
                                <td class="px-6 py-3">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @else
                                            {{-- Fallback / solo ver ficha si quisieras --}}
                                            <a href="{{ route('edured.herramientas.solicitudes-info.paso1', $s) }}"
                                                class="inline-flex items-center px-3 py-2 rounded-md border bg-white hover:bg-gray-50 text-gray-700 text-sm">
                                                Ver / Gestionar
                                            </a>
