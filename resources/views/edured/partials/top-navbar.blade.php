        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <a href="{{ route('edudata.index') }}">
                    <img src="{{ asset('images/eduredlogo.png') }}" alt="EDUREDLogo" class="h-12">
                </a>
            </div>
            ...
            <div class="hidden md:block text-center space-y-1">
                ...
                <div class="flex justify-center items-center space-x-2">
                    <span class="text-sm text-gray-600 font-medium">Ministerio de Educación, Ciencia y Tecnología</span>
            ...
            <div class="flex items-center space-x-3"> <!-- Reduje el espacio entre botones -->
